...
int16_t  AmbientGetOutsideTemp16ths() { return OneWireDeviceGetDataById(_outsideRom); }
int16_t  AmbientGetHeatingTemp16ths() { return OneWireDeviceGetDataById(_heatingRom); }
